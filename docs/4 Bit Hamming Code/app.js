...
function bitwise()
{
    ...
    var parity1 = (str[0]^str[2]^str[3]);
    var parity2 = (str[0]^str[1]^str[3]);
    var parity3 = (str[0]^str[1]^str[2]);
...
function check()
{
    ...
    var hamCode = str[0]+str[1]+str[2]+document.getElementById("parity3").innerHTML+str[3]+document.getElementById("parity2").innerHTML+document.getElementById("parity1").innerHTML;


    var check1 = (hamCode[0]^hamCode[2]^hamCode[4]^hamCode[6]);
    var check2 = (hamCode[0]^hamCode[1]^hamCode[4]^hamCode[5]);
    var check3 = (hamCode[0]^hamCode[1]^hamCode[2]^hamCode[3]);



    document.getElementById("checkBox1").innerHTML=check3;
    document.getElementById("checkBox2").innerHTML=check2;
    document.getElementById("checkBox3").innerHTML=check1;
